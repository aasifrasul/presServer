(function() {
  ...
  router.get('/api/v1/appointments/:doctor_id/:from', appointments.getDoctorAppointments);
  ...
  router.get('/api/v1/prescriptions/:doctor_id/:from', prescriptions.getDoctorPrescriptions);
